...
Templates em branco dos outputs da aula, para quem prefere preencher na mão em vez de rodar a skill do zero (ex.: revisar em equipe antes de formalizar).

- `template-processo-comercial.md` — esqueleto do documento de etapas, critérios de saída (VCA) e gatilhos
- `template-regua-comunicacao.md` — esqueleto de quem fala/canal/régua por tempo parado + mecanismo único
- `template-qualificacao.md` — esqueleto de ICP + roteiro BANT/GPCT + escala de pontuação
